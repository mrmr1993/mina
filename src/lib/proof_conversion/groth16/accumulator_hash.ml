...
let poseidon_hash (fields : Step.Field.t array) : Step.Field.t =
  ...
  Array.iter (fun x -> Sponge.absorb sponge (`Field x)) fields ;
...
let hash_field3_list (xs : FF.Field3.t list) : Step.Field.t =
  let fields =
    List.concat_map (fun (l0, l1, l2) -> [ l0; l1; l2 ]) xs
  in
...
let hash_fp12 (x : Fp12.Circuit.t) : Step.Field.t =
  hash_field3_list
    [ x.c0.c0.c0; x.c0.c0.c1; x.c0.c1.c0; x.c0.c1.c1
    ; x.c0.c2.c0; x.c0.c2.c1; x.c1.c0.c0; x.c1.c0.c1
    ; x.c1.c1.c0; x.c1.c1.c1; x.c1.c2.c0; x.c1.c2.c1
    ]
