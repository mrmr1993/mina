...
let build_circuit_body ~(circuit_index : int) : circuit_body =
  ...
  | 0 ->
      ...
      fun input_hash ->
        ...
        let dummy_field = Step.exists Step.Field.typ ~compute:(fun () ->
            Step.Field.Constant.zero) in
        ...
        Accumulator_hash.combine_hashes
          [ input_hash; Step.Field.of_int 0 ]
  | 1 ->
      ...
      fun input_hash ->
        ...
        Accumulator_hash.combine_hashes
          [ input_hash; Step.Field.of_int 1 ]
  | 2 | 3 | 4 | 5 | 6 ->
  ...
  | 17 | 18 | 19 | 20 | 21 | 22 | 23 ->
      ...
      fun input_hash ->
        ...
        Accumulator_hash.combine_hashes
          [ input_hash; Step.Field.of_int circuit_index ]
  | n ->
      failwith (Printf.sprintf "Invalid PLONK circuit index: %d" n)
